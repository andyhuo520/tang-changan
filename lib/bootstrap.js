...
// 默认直接进入长安世界; 仅当显式 ?home / ?legacy / ?world=off / ?uimode=html 时回到旧首页
const _wantHome = params.has('home') || params.has('legacy')
  || params.get('world') === 'off' || params.get('uimode') === 'html';
const ENABLED = params.has('worldskel') || !_wantHome;
const WORLD_MODE = (params.get('world') && params.get('world') !== 'off')
  ? params.get('world') : 'new'; // 'new' | 'overlay' | 'keepv1'
