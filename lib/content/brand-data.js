...
export const BUILT_IN_BRANDS = [
  {
    ...
    side: 'E',
    featured: true,
    blurb: '【Agora】全球实时互动云服务品牌，最早把实时音视频 SDK 做成"插件"的公司之一。本游戏里你听到的每一句"长安诸贤"，背后跑的就是 Agora 的 ConvoAI——把 ASR、LLM、TTS 拼成一根低延迟的实时音频管线，端到端响应约 1-2 秒，SDK 覆盖 Web、iOS、Android、Flutter、RN。\n【声网】Agora 在中国市场的品牌与运营主体，提供同源的实时互动 PaaS 与本地化合规、支持。二者同根同源，但分开介绍。',
    highlights: [
