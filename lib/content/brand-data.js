 ...
 * 内置 9 个 (Claude / ChatGPT / OpenAI / DeepSeek / Qwen / 智谱 / MiniMax / Kimi + featured Agora 声网).
...
export const BUILT_IN_BRANDS = [
  {
    ...
    side: 'E',
    featured: true,
    blurb: '声网（Agora）是全球最早把实时音视频 SDK 做成"插件"的公司之一。本游戏里你听到的每一句"长安诸贤"，背后跑的就是声网的 ConvoAI——把 ASR、LLM、TTS 拼成一根低延迟的实时音频管线。Agora 的招牌是低于业内平均 6-7 秒一半的端到端响应（约 1-2 秒），SDK 覆盖 Web、iOS、Android、Flutter、RN。',
    highlights: [
    ...
    personaCue: '入"声网馆"——你正站在玩家与你之间这条语音管线的"机房"前。请先用一句"实时声波"的隐喻招呼客人，再点出本馆三件镇馆之宝：ConvoAI、低延迟 RTC、Voice Agent Skill。',
  },
  {
    id: 'anthropic',
