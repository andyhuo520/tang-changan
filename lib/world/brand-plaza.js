...
import { allBrands, addCustomBrand, removeCustomBrand, loadCustomBrands } from '../content/brand-data.js?v=20260529-agora-rename';
...
const BRAND_VOICE_PERSONAS = Object.freeze({
  agora:     { personaId: 'brand_agora',    displayName: '智机使 · Agora 馆',   subtitle: '实时音视频 · ConvoAI' },
