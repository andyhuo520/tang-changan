...
import { allBrands, addCustomBrand, removeCustomBrand, loadCustomBrands } from '../content/brand-data.js?v=20260529-agora-logo';
...
const BRAND_VOICE_PERSONAS = Object.freeze({
  agora:     { personaId: 'brand_agora',    displayName: '智机使 · 声派',   subtitle: 'Agora 馆 · 实时音视频派' },
